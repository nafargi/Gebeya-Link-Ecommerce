                ...
                <div className="container position-relative zindex-5 pt-5">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <h1 className="pb-2 pb-md-3">About Gebeya Link</h1>
              ...
              <section className="container mt-8 mb-5 pt-lg-5" id="benefits">
                ...
                >
                  <div className="swiper-wrapper pt-4">
                    <SwiperSlide className="swiper-slide border-end-lg px-2" triggerOnce>
                    ...
                    <SwiperSlide className="swiper-slide px-2" triggerOnce>
                      <div className="text-center">
                        <Zoom triggerOnce>
                        <img
                          src={team}
                  ...
                  <div className="col-md-5">
                    ...
                    >
                      ...
                      <div className="gallery-item-caption p-4">
                        <h4 className="text-light mb-1">Gebeya Link Inc.</h4>
                    ...
                    <div className="info-whydiff">
                      <div className="section-title-left pt-80">
                        <h3 className="party" style={{ fontSize: "38px" }}>
                          <Slide direction="down" delay={0.5} triggerOnce>
                          Our Partners
                          </Slide>
                        </h3>
                      </div>
