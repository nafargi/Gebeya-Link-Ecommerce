                          ...
                          <div className="row">
                            <div className="col-lg-6 col-12 mb-4">
                              ...
                              <div className="border p-6 rounded-3">
                                ...
                                <address>
                                  {" "}
                                  <strong> Arada</strong> <br /> 4 kilo
                            , <br />
                                  Addis Ababa, Ethiopia<br />
                                  <br />
                                  <abbr title="Phone">P: +251-99-98-96-99</abbr>
                                </address>
                      ...
                      <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item px-4 py-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-5 col-md-5">
                              <h6 className="mb-0">Ye Lewuz Qebe</h6>
                              <span>
                            ...
                            <div className="col-3 text-lg-end text-start text-md-end col-md-3">
                              <span className="fw-bold">350.00 bir</span>
                            </div>
                          </div>
                        </li>
                        {/* list group item */}
                        <li className="list-group-item px-4 py-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-3 text-lg-end text-start text-md-end col-md-3">
                              <span className="fw-bold">50.00 bir</span>
                        ...
                        <li className="list-group-item px-4 py-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-5 col-md-5">
                              <h6 className="mb-0">Sun Chips</h6>
                              <span>
                            ...
                            <div className="col-3 text-lg-end text-start text-md-end col-md-3">
                              <span className="fw-bold">20.00 bir</span>
                              <div className="text-decoration-line-through text-muted small">
                                30.00 bir
                              </div>
                            </div>
                        ...
                        <li className="list-group-item px-4 py-3">
                          <div className="row align-items-center">
                            ...
                            <div className="col-3 text-lg-end text-start text-md-end col-md-3">
                              <span className="fw-bold">15.00 bir</span>
                              <div className="text-decoration-line-through text-muted small">
                                20.00 bir
                              </div>
                            </div>
                        ...
                        <li className="list-group-item px-4 py-3">
                          <div className="d-flex align-items-center justify-content-between   mb-2">
                            ...
                            <div className="fw-bold">435.00 bir</div>
                          </div>
                          <div className="d-flex align-items-center justify-content-between  ">
                            ...
                            <div className="fw-bold">120.00 bir</div>
                          </div>
                        </li>
                        {/* list group item */}
                        <li className="list-group-item px-4 py-3">
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      ...
                      <select className="form-select">
                        ...
                        <option value={3}>Sidama</option>
                        <option value={4}>Tigiray</option>
                        <option value={5}>Dere Dewa</option>
                      </select>
                    </div>
                    {/* col */}
                    <div className="col-12">
                      ...
                      >
                        ...
                        <option value={3}>Mekele</option>
                        <option value={4}>Hawasa</option>
                        <option value={5}>Dere Dewa</option>
                        <option value={6}>Gondar</option>
                        <option value={7}>Jimma</option>
                        <option value={8}>Wolaoita Sodo</option>
                      </select>
                    </div>
                    <div className="col-12">
                      {/* button */}
