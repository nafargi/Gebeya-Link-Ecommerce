                    ...
                    <ul className="list-group list-group-flush">
                      ...
                      <li className="list-group-item py-3 py-lg-0 px-0 border-top">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-2 text-lg-end text-start text-md-end col-md-2">
                            <span className="fw-bold">300.00 bir</span>
                          </div>
                        </div>
                      </li>
                      {/* list group */}
                      ...
                      <li className="list-group-item py-3 py-lg-0 px-0">
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-4 col-md-6">
                            ...
                            <span>
                              <small className="text-muted">290 g</small>
                            </span>
                            {/* text */}
                            <div className="mt-2 small ">
                              {" "}
                      ...
                      <li className="list-group-item py-3 py-lg-0 px-0 border-bottom">
                        ...
                        <div className="row align-items-center">
                          ...
                          {/* price */}
                          <div className="col-2 text-lg-end text-start text-md-end col-md-2">
                            <span className="fw-bold">35.00 bir</span>
                            <div className="text-decoration-line-through text-muted small">
                              45.00 bir
                            </div>
                          </div>
                    ...
                    <div className="card-body p-6">
                      ...
                      <div className="card mb-2">
                        ...
                        <ul className="list-group list-group-flush">
                          ...
                          <li className="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <span className="fw-bold">313.00 bir</span>
                          </li>
                        </ul>
                      </div>
                      <div className="d-grid mb-1 mt-4">
                        ...
                        <button
                          ...
                          type="submit"
                        >
                          Go to Checkout <span className="fw-bold">313.00 bir</span>
                        </button>
                      </div>
                      {/* text */}
                      <p>
