...
import slider10 from "../images/home2.webp";
import minibanner1 from "../images/banner/mini-banner-3.jpg";
import minibanner2 from "../images/banner/mini-banner-1.jpg";
import minibanner3 from "../images/banner/mini-banner-2.jpg";
                    ...
                    <div className=" col-lg-6 col-md-6 fade-in-left">
                      <Slide direction="left" triggerOnce>
                        <div className="mb-6">
                          <div className="mb-7">
                            {/* heading */}
                            <h1>Get <span className="text-primary">Gebeya Link</span> app</h1>
                            <h5 className="mb-0">
                          ...
                          <div className="wt-icon-box-wraper center p-a25 p-b50 m-b30 bdr-1 bdr-gray bdr-solid corner-radius step-icon-box bg-white v-icon-effect">
                            ...
                            <div className="icon-content">
                              ...
                              <p>
                                ...
                                earliest from Gebeya Link pickup
                                <p> stores near you.</p>
                              </p>
                            </div>
                          </div>
